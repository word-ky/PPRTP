...
def run(cfg, mode, seed):
    ...
    if cfg.paired_anchor_probe or cfg.pair_breaking_probe or cfg.persistence_probe:
        ...
        saved_anchors=json.loads(Path('research_log/H03A/gate/artifacts/experiment/fedgh_seed0/paired_anchors.json').read_text()) if (cfg.pair_breaking_probe or cfg.persistence_probe) else None
    ...
    with (out/'rounds.jsonl').open('w') as stream:
        for r in range(cfg.rounds):
            ...
            if mode == 'fedgh' and (cfg.probe_head or cfg.oracle_head or cfg.owner_sample_probe or cfg.heldout_owner_probe or cfg.paired_anchor_probe or cfg.pair_breaking_probe or cfg.persistence_probe):
